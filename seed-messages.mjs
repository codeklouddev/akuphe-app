...
// MongoDB connection
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://akupheapply:FGGdUuegGqYH9oSy@cluster0.ynlsa3n.mongodb.net/portfolio';
...
async function seedMessages() {
  try {
    ...
    if (existingCount > 0) {
      console.log(`Found ${existingCount} existing messages. Keeping them and adding more...`);
      // await ContactMessage.deleteMany({});  // Uncomment to clear existing
    }
